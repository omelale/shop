...
import {ManageProductsStackNavigator, ProductStackNavigator} from "./ProductsStackNavigator";
...
const SideDrawerExtraNavigation = () => {
    return (<NavigationContainer independent={true}>
        <Drawer.Navigator initialRouteName="Home">
            ...
            <Drawer.Screen name="ManageProductsStackNavigator" component={ManageProductsStackNavigator}
                           options={{title: 'Manage Products'}}/>
            <Drawer.Screen name="FavouriteProducts" component={FavouriteProducts}
                           options={{title: 'Favourite Products'}}/>
        </Drawer.Navigator>
    </NavigationContainer>);
}
